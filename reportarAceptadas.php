...
<section class="div_formulario">
	...
	<form class="formulario" action="reportandoAceptadas.php" method="POST"  enctype="multipart/form-data"  onsubmit="return validarFecha2()">
	<p style="text-align:left; font-size:2">Ingrese un rango de fechas de las solicitudes aceptadas que desea visualizar</p><br>
