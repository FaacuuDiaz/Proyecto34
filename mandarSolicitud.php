...
?>
<section class="div_formulario" id="formulario_usuario" action="mandandoSolicitud.php" onSubmit="return validarFecha()">
		<form class="formulario" method="POST" action="mandandoSolicitud.php">
			...
			Ingrese fecha desde: <input type="date" id="fechaDesde" name="fechaD" required min="<?php echo date('Y-m-d')?>" /> &nbsp
			</br>
			Ingrese fecha hasta: <input type="date" id="fechaHasta" name="fechaH" required min="<?php echo date('Y-m-d')?>"  /> </br></br>
