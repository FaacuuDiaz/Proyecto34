...
?>
	<script type="text/javascript">
			...
			{
				if (!confirm("Seguro que quiere eliminar el tipo de Couch?")) { return false; }
				else { document.location = url; return true; }
			}
	</script>
	...
	<div class="columnat">TIPOS DE COUCH</div>
		...
		{	?> 
			<tr>
				...
				<td><a href="javascript:;" onclick="confirmar('eliminarTipo.php?id_tipo=<?php echo $fila['id_tipo']; ?>'); return false;"><img src="img/eliminar.gif" width=15px height=15px></a>				</td>
			</tr>   
			<?php
		}
		?> 
