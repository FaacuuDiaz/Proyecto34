	...
	<section class="listings">
		<div class="wrapper">
			...
			<?php 
				...
				$cont= connection();
				$consulta = "SELECT * from hospedaje where estado='habilitado' order by id_hospedaje desc";
				if ($resultado = mysqli_query($cont, $consulta))
					{
						$cont=1;
						while (($fila = mysqli_fetch_row($resultado))&&($cont<=6)) 
						{ ?>
							<li>
			...
			<div class="more_listing">
				<a href="listarHospedajes.php" class="more_listing_btn">Ver todos los couch</a>
			</div>
		</div>
